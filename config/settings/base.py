...
EMAIL_TO_HR = os.getenv('EMAIL_TO_HR', 'gandharvkartik@gmail.com')  # where Ask HR requests land
ASK_HR_RECIPIENTS = [
    addr.strip() for addr in os.getenv('ASK_HR_RECIPIENTS', EMAIL_TO_HR).split(',')
    if addr.strip()
]
